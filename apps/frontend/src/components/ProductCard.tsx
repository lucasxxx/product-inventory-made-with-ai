type ProductCardProps = {
  ...
  export default function ProductCard({ name, imageUrl, quantity }: ProductCardProps) {
    const status = getStockStatus(quantity);
  
    return (
      <div className="flex items-center bg-black rounded-xl border border-gray-700 p-4 shadow-sm">
        <img
